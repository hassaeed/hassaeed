...
st.write("Upload image(s) to detect Cocconeis (elliptical) and Epithemia (bean-like) diatoms based on their outer shape.")
    ...
    for cnt in contours:
        ...
        if 150 < area < 20000:
            ...
            if M["m00"] != 0:
                cX = int(M["m10"] / M["m00"])
                cY = int(M["m01"] / M["m00"])
                cv2.putText(result, label, (cX - 40, cY), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 0, 0), 1)
